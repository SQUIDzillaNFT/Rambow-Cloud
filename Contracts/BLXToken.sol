...
// Ownable section - Owner/only owner - renounce/transfer contract ownership****cannot be undone use with caution. Renounceing sends ownership to the 0xdead***
...
contract BOLIX_token is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Crypto Bolix Token", "BOLIX") {
    ...
    // exclude an address from buy/sell fees
    ...
    // DeBlacklist an address and remove from Sniper Log
    ...
    // withdrawl fees function - withdrawl fees to the listed Fee/Marketing/Developement wallet from contract balance(recieve accrued fees)
